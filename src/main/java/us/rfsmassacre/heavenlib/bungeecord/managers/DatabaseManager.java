...
public abstract class DatabaseManager<T, X> extends Manager
{
    ...
    public DatabaseManager(BungeePlugin instance, String tableName)
    {
        super(instance);
        ...
        {
            openConnection();
            locale.sendLocale(ProxyServer.getInstance().getConsole(), "mysql.connected",
                    "{table}", tableName);
        }
        catch (SQLException | ClassNotFoundException exception)
        {
            locale.sendLocale(ProxyServer.getInstance().getConsole(), "mysql.failed");
        }
    }
